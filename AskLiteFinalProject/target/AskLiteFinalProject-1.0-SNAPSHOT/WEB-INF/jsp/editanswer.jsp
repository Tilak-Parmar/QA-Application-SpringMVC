<%-- 
    Document   : editanswer
    Created on : Apr 29, 2021, 9:41:48 PM
    Author     : tilak
--%>
...
<html>
    ...
    <div class="container">
        <div style="border-bottom: 1px solid gray; border-radius: 5px;">
            <form action="${pageContext.request.contextPath}/editanswer.htm" method="POST" class="needs-validation" novalidate>
                <h2 class="card-body">Edit Your Answer</h2>
                <div class="form-group">
                    <textarea class="form-control card-body" rows="5" placeholder="What are your thoughts on this?" required name="answer">${requestScope.answer.getAnswer()}</textarea>
                    <div class="invalid-feedback">Required</div>
                </div>
                <input type="hidden" name="ansID" value="${requestScope.answer.getID()}">
